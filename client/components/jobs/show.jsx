ShowJob = React.createClass({
  ...
  siteTo() {
    return `${this.data.job && this.data.job.homepage}`;
  },
              ...
              <div className="row">
                <div className="three columns">
                  ...
                  {this.data.job && this.data.job.homepage? (
                    <div><i className="fa fa-desktop"></i><a className="homepage" href={this.siteTo()} target="_blank">{this.data.job && this.data.job.homepage}</a>  </div>
                  ) : null}
                  <i className="fa fa-envelope"></i><a className="email" href={this.mailtoEmail()}>{this.data.job && this.data.job.email}</a>
                  <hr />
                  <i className="fa fa-calendar"></i><span className="created-at">Anunciado em {this.createdAt()}</span>
                </div>
