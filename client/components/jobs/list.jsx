          ...
          <div className="row">
            <div className="twelve columns">
              <form onSubmit={this.searchJobs}>
                <input type="text" id="search-query" className="u-full-width" placeholder="Digite algo (ex. Vendedora ou Soldador) e pressione enter" onChange={this.watchSearchQuery}/>
              </form>
            </div>
          </div>
          <div className="row">
            <div className="twelve columns">
              {this.jobItems().length ? (
                this.jobItems()
              ) : <div className="alert info">Não existem vagas para serem exibidas</div> }
            </div>
          </div>
          <div className="row">
            <div className="twelve columns">
